                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                            {/* Option 1: Take Photo (Mobile Friendly) */}
                            <button
                                type="button"
                                onClick={() => document.getElementById('cameraInput').click()}
                                className="flex items-center justify-center space-x-2 py-3 px-4 rounded-xl border-2 border-blue-100 bg-blue-50 text-blue-700 hover:bg-blue-100 hover:border-blue-300 transition-all"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center space-x-2 py-3 px-4 rounded-xl border-2 border-gray-200 bg-white text-gray-700 hover:border-gray-400 hover:bg-gray-50 transition-all"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="grid grid-cols-3 gap-2 mt-4">
                                {preview.map((src, index) => (
                                    <div key={index} className="relative group">
                                        <img src={src} alt={`Preview ${index}`} className="w-full h-24 object-cover rounded-lg shadow-sm border border-gray-200" />
                                        <button
                                            type="button"
                                            onClick={() => {
